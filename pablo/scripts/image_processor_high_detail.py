...
class ImageProcessor(Node):
    ...
    def process_image(self):
        ...
        # Apply Blur and Detect edges using Canny
        # # Extra Detail in Clothes
        # gray_no_hair = gray_image
        # gray_no_hair[hair_mask == 255] = 0  # Set hair
        # # alpha_mask = gray_no_hair[:, :, 3]
        # # outer_mask = cv2.bitwise_and(alpha_mask, cv2.bitwise_not(gray_no_hair))
        # cv2.imwrite(os.path.join(self.output_dir, "4_gray_no_hair.jpg"), gray_image)
